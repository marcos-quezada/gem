/*
 * Implements the libgem transport and the application-level AES wrappers:
 * the Unix-domain connection with peer-credential checks, framed request
 * and reply exchange with USERDEF callback round trips, appl_init/exit,
 * event polling with client-side timers, graf_handle/graf_mouse and
 * form_alert.
 *
