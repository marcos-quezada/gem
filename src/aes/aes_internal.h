...
#ifndef GEM_AES_INTERNAL_H
#define GEM_AES_INTERNAL_H
...
typedef struct aes_app {
     ...
     * yet matched by END_UPDATE. aes_state.update_depth is a single global
...
extern int (*aes_wait_hook)(void);
/* gemd routes physical input centrally; evnt_multi consumes app queues only. */
extern int aes_external_input;
...
extern const GRECT *aes_modal_cover;
 ...
 * a dirty rectangle via vdi_flush_rect).
 */
